...
from mushroom.util.util import load_numpy_array_data,save_object,load_object
from mushroom.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from mushroom.entity.model_factory import evaluate_regression_model



class MushroomEstimatorModel:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = MushroomEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
